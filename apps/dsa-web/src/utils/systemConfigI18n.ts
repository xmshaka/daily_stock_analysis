...
const fieldTitleMap: Record<string, string> = {
  ...
  ANYSEARCH_API_KEYS: 'AnySearch API Keys',
  ANYSEARCH_DAILY_LIMIT: 'AnySearch 每日调用上限',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  ANYSEARCH_API_KEYS: 'AnySearch 搜索 API Keys（逗号分隔，中文 A 股垂直搜索强项；不填走匿名访问，限额较低）。',
  ANYSEARCH_DAILY_LIMIT: 'AnySearch 每日调用上限（匿名默认 200，超出后本日不再调用 AnySearch）。',
