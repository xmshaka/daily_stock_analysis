...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MINIMAX_API_KEYS": {
        ...
        "description": "MiniMax API key (search priority: Bocha > Tavily > Brave > SerpAPI > MiniMax > AnySearch).",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "ANYSEARCH_API_KEYS": {
        "title": "AnySearch API Keys",
        "description": "Comma-separated AnySearch API keys. Anonymous access works but has stricter rate limits; configure a key to raise the daily quota.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "help_key": "settings.data_source.search_api_keys",
        "examples": [
            "ANYSEARCH_API_KEYS=as_xxxx",
            "ANYSEARCH_API_KEYS=as_key_1,as_key_2",
        ],
        "docs": [
            {
                "label": "AnySearch 官网",
    ...
    "ANYSEARCH_DAILY_LIMIT": {
        "title": "AnySearch Daily Quota",
        "description": "Maximum AnySearch calls per day. Anonymous keys default 200; configured keys can be raised.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0},
        "display_order": 54,
        "help_key": "settings.data_source.ANYSEARCH_DAILY_LIMIT",
        "examples": [
            "ANYSEARCH_DAILY_LIMIT=200",
            "ANYSEARCH_DAILY_LIMIT=2000",
        ],
        "docs": [
            {
                "label": "AnySearch 项目仓库",
                "href": "https://github.com/anysearch/anysearch",
            },
        ],
    },
